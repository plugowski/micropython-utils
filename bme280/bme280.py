"""
Library for BME280 based on https://github.com/DFRobot/micropython-dflib/blob/master/BME280/lib/BME280.py
Fixed temperature, pressure and humidity calculations for human reading values.
"""
...
class BME280:
    ...
    def temperature(self):
        ...
        var2 = ((ut / 131072.0 - float(self.dig_T1) / 8192.0) * (ut / 131072.0 - float(self.dig_T1) / 8192.0)) * float(
            self.dig_T3)
